...
public class RightTest {
  ...
  @Test
  public void givenDirectedPosition1x1NWhenTurnRightThenGetDirectedPosition1x1E() {
    // Given
    DirectedPosition orientedPosition1x1N = new DirectedPosition(Direction.N, new Position(1, 1));
    Right moveRight = new Right();

    // When
    DirectedPosition directedPosition = moveRight.executeFrom(orientedPosition1x1N);
  ...
  @Test
  public void givenDirectedPosition1x1OWhenTurnRightThenGetDirectedPosition1x1N() {
    // Given
    DirectedPosition orientedPosition1x1W = new DirectedPosition(Direction.W, new Position(1, 1));
    Right moveRight = new Right();

    // When
    DirectedPosition directedPosition = moveRight.executeFrom(orientedPosition1x1W);
  ...
  @Test
  public void givenDirectedPosition1x1SWhenTurnRightThenGetDirectedPosition1x1W() {
    // Given
    DirectedPosition orientedPosition1x1S = new DirectedPosition(Direction.S, new Position(1, 1));
    Right moveRight = new Right();

    // When
    DirectedPosition directedPosition = moveRight.executeFrom(orientedPosition1x1S);
  ...
  @Test
  public void givenDirectedPosition1x1EWhenTurnRightThenGetDirectedPosition1x1S() {
    // Given
    DirectedPosition orientedPosition1x1E = new DirectedPosition(Direction.E, new Position(1, 1));
    Right moveRight = new Right();

    // When
    DirectedPosition directedPosition = moveRight.executeFrom(orientedPosition1x1E);
